...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function getInformationFromDB(_x) {
    return _getInformationFromDB.apply(this, arguments);
  }

  function _getInformationFromDB() {
    _getInformationFromDB = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
      var res;
  ...
  getInformationFromDB('http://localhost:3000/list').then(function (data) {
    console.log(data);
    data.forEach(function (item) {
      return abbrList.push(item.name);
    });
  ...
  var InfoCard = /*#__PURE__*/function () {
    function InfoCard(name, designation, designationRu, descriptionRu, parent) {
    ...
    _createClass(InfoCard, [{
      ...
      value: function render() {
        ...
        content.innerHTML = "\n                <div class=\"main__header\">".concat(this.name, "</div>\n                <div class=\"main__title\">").concat(this.designation, "</div>\n                <div class=\"main__subtitle\">(").concat(this.designationRu, ")</div>\n                <div class=\"main__descr\">").concat(this.descriptionRu, "</div>\n            ");
  ...
  function setActeveClass(element, activeClass) {
    var listItems = document.querySelectorAll('.list__field ul li');
